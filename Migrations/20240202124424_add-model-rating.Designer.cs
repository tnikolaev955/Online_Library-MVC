...
namespace Online_Library.Migrations
{
    ...
    [Migration("20240202124424_add-model-rating")]
            ...
            modelBuilder.Entity("Online_Library.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Description = "Фантастиката предоставя възможност за изследване на невероятни светове и идеи. Този жанр включва различни подкатегории, които предоставят читателите научнофантастични или фантастични приключения.",
                            Title = "Фантастика"
                        },
                        new
                        {
                        ...
                        {
                            Id = 7,
                            Description = "Фентъзито включва елементи от въображаемо и магическо, предоставяйки на читателите възможността да избягат от реалността и да се потопят в светове, пълни с магия, създания и приключения.",
                            ParentId = 6,
                            Title = "Фентъзи"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Title = "Детска и Юношеска Лит."
                        },
                        new
                        {
                            Id = 12,
                            Description = "Приключенските романи предоставят читателят възможността да се потопят в изпълнени с действие истории. Героите често се изправят пред различни предизвикателства и опасности.",
            ...
            modelBuilder.Entity("Online_Library.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 2, 14, 44, 23, 628, DateTimeKind.Local).AddTicks(4063),
