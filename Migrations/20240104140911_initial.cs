        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOnlineBook = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReaderCards_Users_User_id",
                        column: x => x.User_id,
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthdate", "CreatedAt", "Email", "Name", "Password", "Role", "UpdatedAt", "Username" },
                values: new object[] { 1, new DateOnly(1, 1, 1), new DateTime(2024, 1, 4, 16, 9, 10, 712, DateTimeKind.Local).AddTicks(9349), "gergankabibli@gmail.com", "Иванка", "Password12345", "Библиотекар", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "gerganka" });
